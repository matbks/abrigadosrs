    ...
    <div className="App">
      ...
      <Flex boxShadow="lg"
        ...
        <Flex align="top" mr={5} alignItems='center' marginStart='2'> 
            <FaHome p="2" _hover={{ textDecoration: 'none', opacity: 0.8}}></FaHome>
          
          
          <Link href="#" p="2" _hover={{ textDecoration: 'none', opacity: 0.8 }} marginStart='2'>
            Doe
          </Link>
          <Link href="#" p="2" _hover={{ textDecoration: 'none', opacity: 0.8 }}>
            Sobre
          </Link>
        </Flex>
      </Flex>
